...
const TRANSITIONS: Dictionary = {
	STATE_GROUND: [STATE_CROUCH, STATE_SPRINT, STATE_WALL_CLING, STATE_CLIMB, STATE_CRAWLSPACE, STATE_SWIM_SURFACE, STATE_HIDDEN, STATE_ASSASSINATE],
	STATE_CROUCH: [STATE_GROUND, STATE_SPRINT, STATE_WALL_CLING, STATE_CLIMB, STATE_CRAWLSPACE, STATE_SWIM_SURFACE, STATE_HIDDEN, STATE_ASSASSINATE],
	STATE_SPRINT: [STATE_GROUND, STATE_CROUCH, STATE_SWIM_SURFACE],
	STATE_WALL_CLING: [STATE_GROUND, STATE_CLIMB, STATE_ASSASSINATE],
	STATE_CLIMB: [STATE_GROUND, STATE_BEAM],
	STATE_BEAM: [STATE_GROUND, STATE_CLIMB, STATE_ASSASSINATE],
	STATE_CRAWLSPACE: [STATE_CROUCH, STATE_ASSASSINATE],
	...
	STATE_ASSASSINATE: [STATE_GROUND, STATE_CRAWLSPACE],
}
