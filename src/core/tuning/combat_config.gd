...
@export_range(0.0, MAX_DURATION_SECONDS, 0.05) var attack_startup_seconds: float = 0.10
@export_range(0.05, MAX_DURATION_SECONDS, 0.05) var attack_active_seconds: float = 0.20
@export_range(0.0, MAX_DURATION_SECONDS, 0.05) var attack_recovery_seconds: float = 0.25
...
@export_range(0.0, MAX_DURATION_SECONDS, 0.05) var parry_cooldown_seconds: float = 0.35
@export_range(0.05, MAX_DURATION_SECONDS, 0.05) var dodge_invulnerability_seconds: float = 0.35
@export_range(0.0, MAX_DURATION_SECONDS, 0.05) var dodge_cooldown_seconds: float = 0.80
...
@export_range(0.0, MAX_DURATION_SECONDS, 0.05) var hit_invulnerability_seconds: float = 0.20
...
static func _bounded_duration(value: float, fallback: float) -> float:
	return clampf(value, 0.0, MAX_DURATION_SECONDS) if is_finite(value) else fallback
