...
signal combat_attack(attacker: Node, target: Node, damage: int)
signal combat_parried(player: Node, attacker: Node)
signal combat_dodged(player: Node, attacker: Node)
signal player_damaged(player: Node, damage: int, remaining_health: int, source: Node)
signal player_defeated(player: Node)
signal enemy_damaged(enemy: Node, damage: int, remaining_health: int, source: Node)
