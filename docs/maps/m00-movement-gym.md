...
- The climb entry edge is at `(-8, 0, -6)`. Its top connects to the start of the 6 m beam at `(-8, 2.5, -6)`.
- The beam end connects to the exit edge at `(-2, 2.5, -6)`, whose ground endpoint is `(-2, 0, -6)`.
