...
func test_residence_route_geometry_keeps_veranda_and_crawlspace_open() -> void:
	...
	assert_true(residence._route_points_have_support(crawl_points))
	assert_true(residence._route_segments_are_clear(crawl_points, &"C_crawlspace"))
	assert_true(residence._route_navigation_covers(crawl_points, &"C_crawlspace"))
